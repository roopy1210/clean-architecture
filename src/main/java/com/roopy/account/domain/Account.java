...
public class Account {
    ...
    public Money calculateBalance() {
        System.out.println("[Account.calculateBalance] baselineBalance : " + baselineBalance);
        System.out.println("[Account.calculateBalance] activityWindow : " + this.id);
        return Money.add(
    ...
    public boolean deposit(Money money, AccountId sourceAccountd) {
